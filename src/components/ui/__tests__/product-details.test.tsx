...
describe('ProductDetails', () => {
  ...
  describe('Cancellation Reasons', () => {
    it('displays cancellation reason for cancelled products', () => {
      ...
      expect(screen.getByText('Contains harmful ingredient XYZ that may cause skin irritation')).toBeInTheDocument();
    });
  ...
  describe('Safety Information for Cancelled Products', () => {
    it('displays safety notice for cancelled products when expanded', () => {
      ...
      expect(screen.getByText(/This product has been cancelled and should not be used/)).toBeInTheDocument();
    });
