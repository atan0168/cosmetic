...
// Mock fetch for alternatives API
global.fetch = vi.fn();
...
describe('ProductDetails', () => {
  ...
  describe('Cancellation Reasons', () => {
    it('displays cancellation reason for cancelled products', () => {
      renderWithQueryClient(<ProductDetails product={mockCancelledProduct} />);
    ...
    it('displays fallback message when cancellation reason is missing', () => {
      renderWithQueryClient(<ProductDetails product={mockCancelledProductNoReason} />);
    ...
    it('displays fallback message when cancellation reason is empty string', () => {
      ...
      renderWithQueryClient(<ProductDetails product={productWithEmptyReason} />);
    ...
    it('formats cancellation reason with proper capitalization', () => {
      ...
      renderWithQueryClient(<ProductDetails product={productWithLowercaseReason} />);
    ...
    it('cleans up multiple spaces in cancellation reason', () => {
      ...
      renderWithQueryClient(<ProductDetails product={productWithMessyReason} />);
  ...
  describe('Company Information', () => {
    ...
    it('shows vertically integrated badge when applicable', () => {
      renderWithQueryClient(
        <ProductDetails product={mockCancelledProduct} defaultExpanded={true} />,
      );
